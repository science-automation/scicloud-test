...
def test_exception1():
    '''Raise TypeError since cloud.environment.shutdown called with 1 arguments'''
    cloud.environment.shutdown('asdfd')

@raises(TypeError)
def test_exception2():
    '''Raise TypeError since cloud.environment.shutdown called with 2 arguments'''
    cloud.environment.shutdown('asdfd','asdg')
